                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="/admin/menu/save" method="post">
                                                ...
                                                <li class="dd-item" data-id="<?= $data['menu_id']; ?>">
                                                    ...
                                                    <div class="dd3-actions position-absolute" style="right: 0; top: 0;">
                                                        <div class="btn-group">
                                                            ...
                                                            <form action="/admin/menu/delete/<?= $data['menu_id']; ?>">
                            ...
                            <button class="btn btn-primary d-inline float-right mt-3" disabled id="btnMenu" type="submit">
                                <p class="d-inline">
                                    Save
                                </p>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="/admin/menu/save" method="post" id="form">
                            ...
                            <div class="input-group mb-3">
                                <input type="text" class="form-control" placeholder="Link" name="link" value="<?= $url; ?>">
                            </div>
                            <label>Status</label>
                            <div>
                                <div class="form-check d-inline">
                                    <input class="form-check-input" type="radio" name="target" id="self" <?= $target == '_self' ? 'checked' : ''; ?> value="_self" checked>
                                    <label class="form-check-label" for="self">
                                        Self
                                    </label>
                                </div>
                                <div class="form-check d-inline">
                                    <input class="form-check-input" type="radio" name="target" id="blank" <?= $target == '_blank' ? 'checked' : ''; ?> value="_blank">
